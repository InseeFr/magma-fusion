...
If you contribute to Magma-API, you may fall in troubles with IntelliJ because the module `magma-fusion-interface`
contains generated source code which can be ignored by IntelliJ and cause failures in `magma-fusion-impl` builds. To prevent this,
the directory `magma-fusion-interface/target/generated-sources/openapi/src/main/java` must be marked as a _Generated Sources Root_. This can be done in two steps :
