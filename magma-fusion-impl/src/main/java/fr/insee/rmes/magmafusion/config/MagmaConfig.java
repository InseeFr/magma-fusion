package fr.insee.rmes.magmafusion.config;
...
public class MagmaConfig {
    ...
    public Configuration freemarkerConfiguration
            ...
            @Value("${fr.insee.rmes.magmafusion.organisations.graph:organisations}") String organisationsGraph,
            @Value("${fr.insee.rmes.magmafusion.adms.graph:adms}") String admsGraph,
            @Value("${fr.insee.rmes.magmafusion.ontologies.baseURI:ontologies/insee/base}") String ontologiesGraph,
            @Value("${fr.insee.rmes.magmafusion.operations.graph:operations}") String seriesOperationsGraph,
            @Value("${fr.insee.rmes.magmafusion.lg1:fr}") String lg1,
            @Value("${fr.insee.rmes.magmafusion.lg2:en}") String lg2) throws URISyntaxException, IOException, TemplateModelException {
