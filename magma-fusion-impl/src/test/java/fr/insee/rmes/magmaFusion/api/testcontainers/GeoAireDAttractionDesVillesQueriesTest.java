...
import fr.insee.rmes.magmaFusion.model.AireDAttractionDesVilles2020;
...
class GeoAireDAttractionDesVillesQueriesTest extends TestcontainerTestDiffusion {
    ...
    void should_return_1_aireDAttractionDesVilles_when_aireDAttractionDesVilles2020Code_code062_date20250904(){
        ...
        assertEquals(TypeEnum.AIRE_D_ATTRACTION_DES_VILLES2020, result.getType());
