...
public class TestcontainerTestDiffusion {
    static GraphDBContainerDiffusion container = new GraphDBContainerDiffusion("ontotext/graphdb:10.8.8").withReuse(false);
