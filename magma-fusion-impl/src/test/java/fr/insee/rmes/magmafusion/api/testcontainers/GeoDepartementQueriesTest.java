...
class GeoDepartementQueriesTest extends TestContainer {
    ...
    class GetCogDepDesc {
        ...
        @Test
        @DisplayName("When getcogdepdesc 10 type null, returns 13 descendants (3 arr + 1 arrmu + 2 can + 2 cov + 3 com + 2 comdel)")
        void should_return_13_descendants_when_getcogdepdesc_10_type_null() throws Exception {
