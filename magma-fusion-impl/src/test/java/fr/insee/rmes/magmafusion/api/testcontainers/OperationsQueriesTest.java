...
class OperationsQueriesTest extends TestcontainerTestDiffusion {
    ...
    void should_return_rapportQualite1979_when_OperationsRapportQualite_id1979() {
        ...
        assertAll(
                ...
                () -> assertEquals("2018T006EC", rubrique_I_6_4.getLabel().getFirst().getContenu()),
                () -> assertEquals("fr", rubrique_I_6_4.getLabel().getFirst().getLangue()),
                () -> assertEquals("2018T006EC", rubrique_I_6_4.getLabel().getLast().getContenu()),
